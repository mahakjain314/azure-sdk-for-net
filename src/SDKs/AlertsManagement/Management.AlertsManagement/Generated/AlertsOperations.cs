    ...
    internal partial class AlertsOperations : IServiceOperations<AlertsManagementClient>, IAlertsOperations
    {
        ...
        public async Task<AzureOperationResponse<IPage<Alert>>> GetAllWithHttpMessagesAsync(string targetResource = default(string), string targetResourceGroup = default(string), string targetResourceType = default(string), string monitorService = default(string), string monitorCondition = default(string), string severity = default(string), string alertState = default(string), string smartGroupId = default(string), bool? includePayload = default(bool?), int? pageCount = default(int?), string sortBy = default(string), string sortOrder = default(string), string timeRange = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (_shouldTrace)
            {
                ...
                tracingParameters.Add("includePayload", includePayload);
            ...
            {
                _queryParameters.Add(string.Format("includePayload={0}", System.Uri.EscapeDataString(Rest.Serialization.SafeJsonConvert.SerializeObject(includePayload, Client.SerializationSettings).Trim('"'))));
            }
            if (pageCount != null)
            {
        ...
        /// A response object containing the response body and response headers.
        /// </return>
        public async Task<AzureOperationResponse<AlertsSummary>> GetSummaryWithHttpMessagesAsync(string targetResourceGroup = default(string), string timeRange = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (Client.SubscriptionId == null)
            {
                throw new ValidationException(ValidationRules.CannotBeNull, "this.Client.SubscriptionId");
